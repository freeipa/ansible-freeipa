...
# Ensure sysaccount my-app is privileged
- ipasysaccount:
    ipaadmin_password: SomeADMINpassword
    name: my-app
    privileged: true

# Ensure sysaccount my-app is not privileged
- ipasysaccount:
    ipaadmin_password: SomeADMINpassword
    name: my-app
    privileged: false

# Ensure sysaccount my-app is disabled
- ipasysaccount:
    ipaadmin_password: SomeADMINpassword
    name: my-app
    state: disabled

# Ensure sysaccount my-app is enabled
- ipasysaccount:
    ipaadmin_password: SomeADMINpassword
    name: my-app
    state: enabled
